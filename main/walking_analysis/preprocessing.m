%% Where are my files and what are the global variables
filepath='your_filepath';
cd(filepath)
addpath(genpath(filepath));

%% What channels are present in the data
...
fileName = 'Fly_ID.xlsx';
FlyIdFilePath = fullfile(filepath, fileName);
[Date, FlyNumber, TrialNumber, CellNumber] = fcn_Excelimport(FlyIdFilePath, 'Sheet1', [1,99]);
...
%%
save('preprocessed_data','analysis','-v7.3');
