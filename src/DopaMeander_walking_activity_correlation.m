...
dataFile = fullfile(rootPath, 'data/DopaMeander_walking_activity_correlation', 'post_walking_Imposter.mat');
...
% Define plots folder
plotsFolder = fullfile(rootPath, 'plots/DopaMeander_walking_activity_correlation');
