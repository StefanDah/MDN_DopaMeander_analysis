...
- **data/** – Raw or preprocessed input data (no data included)  
- **functions/** – Reusable MATLAB helper functions  
- **src/** – Main analysis  scripts  
- **plots/** – Output for plots
- **requirements.txt** – Software/toolbox requirements  
- **LICENSE** – MIT License  
- **README.md** – This file  
## Dependencies
